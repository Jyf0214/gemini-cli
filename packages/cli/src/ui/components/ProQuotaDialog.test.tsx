...
describe('ProQuotaDialog', () => {
  ...
  describe('for non-flash model failures', () => {
    describe('when it is a terminal quota error', () => {
      it('should render switch and stop options (no upgrade option)', async () => {
        const { unmount } = await render(
          <ProQuotaDialog
      ...
      it('should render switch and stop options (no upgrade option for free tier)', async () => {
        const { unmount } = await render(
          <ProQuotaDialog
            failedModel="gemini-2.5-pro"
            fallbackModel="gemini-2.5-flash"
      ...
      it('should render switch and stop options (no upgrade option for Ultra tier)', async () => {
        const { unmount } = await render(
          <ProQuotaDialog
            failedModel="gemini-2.5-pro"
            fallbackModel="gemini-2.5-flash"
